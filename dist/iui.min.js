(function(d,c,a,f){c.IUI_UTILS={animateEnd:"webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",transitionEnd:"webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd",toggleClass:function(i,j){var h=j instanceof d?j:d(j);var g=h.hasClass(i)?"removeClass":"addClass";h[g](i)},isPlaceholder:function(){var g=a.createElement("input");return"placeholder" in g},throttle:function(h,j,n){var g,l,o;var m=null;var k=0;if(!n){n={}}var i=function(){k=n.leading===false?0:new Date().getTime();m=null;o=h.apply(g,l);if(!m){g=l=null}};return function(){var p=new Date().getTime();if(!k&&n.leading===false){k=p}var q=j-(p-k);g=this;l=arguments;if(q<=0||q>j){clearTimeout(m);m=null;k=p;o=h.apply(g,l);if(!m){g=l=null}}else{if(!m&&n.trailing!==false){m=setTimeout(i,q)}}return o}},debounce:function(i,k,h){var n,m,g,l,o;var j=function(){var p=new Date().getTime()-l;if(p<k&&p>0){n=setTimeout(j,k-p)}else{n=null;if(!h){o=i.apply(g,m);if(!n){g=m=null}}}};return function(){g=this;m=arguments;l=new Date().getTime();var p=h&&!n;if(!n){n=setTimeout(j,k)}if(p){o=i.apply(g,m);g=m=null}return o}}};c.IUI={};d.fn.IUI=function(){var g=arguments;var i=arguments[0];if(IUI[i]){i=IUI[i];g=Array.prototype.slice.call(g,1);return i.apply(this,g)}else{if(typeof(i)=="object"||!i){for(var h in i){IUI=d.extend(IUI,i);i=IUI[h];break}}else{d.error("Method "+i+" does not exist on jQuery.IUI Plugin");return this}}};var e=d({});d.extend({sub:function(){e.on.apply(e,arguments)},unsub:function(){e.off.apply(e,arguments)},pub:function(){e.trigger.apply(e,arguments)}});d.extend({alert:function(p){var j=d("body");var m=a.all&&!c.atob?0:200;var i={title:"",content:"",confirmText:"确定",cancelText:"取消",closeBtn:false,shadow:true,type:"confirm",status:"default",keyboard:true,before:function(){},confirm:function(){},cancel:function(){}};var h=d.extend({},i,p);var g=k();var o={showAlert:function(){n(g)},hideAlert:function(){l(g)},target:g};if(!d.alertBackdrop){d.alertBackdrop=d('<div class="IUI-alert-backdrop" style="display:none"></div>');j.append(d.alertBackdrop)}if(h.shadow){j.on("touchstart.iui-alert click.iui-alert",".IUI-alert-container",function(q){q.preventDefault();l(g)})}j.on("touchstart.iui-alert click.iui-alert",".IUI-alert-main",function(q){q.stopPropagation()});g.on("touchstart.iui-alert click.iui-alert",".IUI-alert-confirm",function(q){if(h.type==="alert"){if(h.cancel.call(this,o)===false){return false}l(g);return false}if(h.confirm.call(this,o)===false){return false}});g.on("touchstart.iui-alert click.iui-alert",".IUI-alert-cancel,.IUI-alert-close",function(q){if(h.cancel.call(this,o)===false){return false}l(g)});if(h.keyboard){if(h.keyboard){d(c).on("keyup.iui-alert",function(q){if(q.keyCode===27){g.find(".IUI-alert-cancel,.IUI-alert-close").trigger("click.iui-alert")}if(q.keyCode===13){g.find(".IUI-alert-confirm").trigger("click.iui-alert")}})}}function n(q){q.removeClass("hide");q.find(".IUI-alert-main").addClass("alert-opening");d.alertBackdrop.fadeIn(m,function(){q.find(".IUI-alert-main").removeClass("alert-opening")})}function l(q){d([j,q]).off("touchstart.iui-alert click.iui-alert");q.addClass("alert-closing");d.alertBackdrop.fadeOut(m,function(){d(this).addClass("hide");q.remove()})}function k(){var t=h.type==="confirm";var w='<span class="IUI-alert-close"></span>';var s='<a href="javascript:;" class="IUI-alert-confirm">'+h.confirmText+"</a>";var v='<a href="javascript:;" class="IUI-alert-cancel">'+h.cancelText+"</a>";var y='<div class="IUI-alert-header">'+(h.title||"")+(h.closeBtn?w:"")+"</div>";var u='<div class="IUI-alert-content">'+(h.content||"")+"</div>";var r='<div class="IUI-alert-footer">'+s+(t?v:"")+"</div>";var q=y+u+r;var x=d('<div class="IUI-alert-container hide"><div class="IUI-alert-main '+h.status+'">'+q+"</div></div>");j[0].appendChild(x[0]);return x}if(h.before.call(this,o)===false){return false}n(g)}});
/*!
